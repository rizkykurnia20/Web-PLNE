  ...
  <div class='lof-main-item-desc2'><!--img src=$f[folder]/images/bg_headline.png width='360' height='300'  commented 04112015-->
  ...
  <!------------------------ PILIHAN REDAKSI ------------------------------>
   <!-- <div class="post-title"><b>PENGUMUMAN</b></div>
 ...
 <!----------- PARIWARA ------------------------>
  ...
  <div class="sidebar-title"><b>Ketua STIK-PTIK</b></div>
  <div class="photos">
  <?php
...
<div class="sidebar-item">
  <div class="twitter-ticker">
        <div class="top-bar">
          ...
          <div class="twitIcon"><img src="layout/biru/images/twitter_64.png" width="32" height="32" alt="Twitter icon" /></div>
        
            <h2 class="tut">STIK-PTIK tweets</h2>
            </div>
            
            <div class="tweet-container"><img id="loading" src="layout/biru/images/loading.gif" width="16" height="11" alt="Loading.." /></div>
  ...
  */
  ...
  <div class="sidebar-item">
  <div class="photo-gallery-widget">
  <div class="sidebar-title"><b>Gallery</b></div>
  <?php
 ...
 elseif ($_GET['module']=='notfound'){
  ...
  //********** Copyright © 2015. Developed by: Bambang Suhendro  ********
