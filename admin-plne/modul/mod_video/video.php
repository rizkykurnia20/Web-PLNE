...
switch($_GET[act]){
  ...
  default:
   ...
   <a href=javascript:confirmdelete('$aksi?module=video&act=hapus&id=$r[id_video]&namafile=$r[gbr_video]&namafile2=$r[video]') 
  ...
  <input type=text name='jdl_video' size=60>
   ...
   ex: <span class style=\"color:#EA1C1C;\">http://www.youtube.com/embed/xbuEmoRWQHU
   </p> 	   
						  			
   <p class=inline-small-label> 
   <label for=field4>Video File</label>
   <input type=file name='fupload2' size=40> <br/>
   <span class style=\"color:#EA1C1C;\">File video MP4/FLV
   </p> ";
  ...
  <input type=text name='jdl_video' size=60 value='$r[jdl_video]'>
   ...
   <br/><br/><a href='../play-$r[id_video]-$r[jdl_video].html' target='blank' class='button red'> Test Play on website </a></div>
    ...
    <input type=file name='fupload2' size=30>
	 <br/>
   <span class style=\"color:#EA1C1C;\">File video harus MP4/FLV
    </p>";
