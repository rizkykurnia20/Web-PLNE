...
JQTWEET = {
    ...
    user: 'stikptik1', //username
    numTweets: 1, //number of tweets
    appendTo: '.twitter-ticker'//'NAME OF DIV YOU WANT TWEETS TO APPEAR IN',
    ...
    timeAgo: function(dateString) {
		...
		//if (navigator.userAgent.toLowerCase().indexOf('msie 6') != -1) for jquery  version 1.9 upwards
        }
